...
- MEDIUM: application with 23 step reasoning, patient scenario preferred
- HARD: full USMLE Step 2 style  46 sentence patient vignette, 5 answer choices (AE), one clearly correct, one attractive distractor, explanation for each choice
