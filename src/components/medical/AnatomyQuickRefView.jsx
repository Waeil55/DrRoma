...
const ANATOMY_SYSTEMS = [
  ...
  { id: 'neuro', name: 'Central Nervous System', icon: '🧠',
    structures: [
      ...
      { name: 'Temporal Lobe', details: 'Wernicke area (speech comprehension, dominant). Hippocampus (memory formation). Auditory cortex. Seizure focus → déjà vu, olfactory aura.' },
