...
const VENT_WAVEFORMS = [
  ...
  { id: 'modes', title: 'Mode Quick Reference', icon: '',
    items: [
      { term: 'AC/VC (Assist-Control Volume)', def: 'Set: Vt, RR, FiO, PEEP, flow rate. Guaranteed tidal volume. Pressure varies.', detail: 'Each breath delivers set Vt. Patient can trigger additional breaths (all at set Vt). Constant flow pattern. Monitor: PIP, Pplat, auto-PEEP.', pearl: 'ARDSNet protocol uses AC/VC: Vt 6 mL/kg IBW, Pplat 30 cmHO. If Pplat >30:  Vt to 5 or 4 mL/kg. Allow permissive hypercapnia (pH >7.20). PEEP/FiO table-guided.' },
      { term: 'AC/PC (Assist-Control Pressure)', def: 'Set: P (above PEEP), RR, FiO, PEEP, I-time. Guaranteed pressure. Volume varies.', detail: 'Each breath maintains set P. Decelerating flow pattern. Vt varies with compliance/resistance  MUST monitor Vt closely. If compliance worsens  Vt drops.', pearl: 'PC advantage: decelerating flow is more physiologic, better distribution of ventilation. Disadvantage: Vt NOT guaranteed  if patient desaturates, check if Vt dropped (worsening compliance  need to  P).' },
