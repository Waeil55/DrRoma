...
const PATHOLOGY_DATA = [
  ...
  { id: 'stains', title: 'Special Stains & IHC', icon: '',
    items: [
      ...
      { term: 'GMS (Grocott Methenamine Silver)', def: 'Fungal cell walls stain black against green background.', detail: 'Best stain for Pneumocystis jirovecii (PJP), also excellent for other fungi.', pearl: 'PJP: ground-glass opacities on CT,  LDH,  -glucan, CD4 <200 in HIV. Treat: TMP-SMX + steroids if PaO <70.' },
