...
const TOXICOLOGY_DATA = [
  ...
  { toxin: 'Tricyclic Antidepressants (TCAs)', mechanism: 'Block Na channels (cardiac), muscarinic receptors (anticholinergic), H receptors,  receptors, serotonin/NE reuptake',
