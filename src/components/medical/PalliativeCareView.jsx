...
const PALLIATIVE_SECTIONS = [
  { id: 'symptom', title: 'Symptom Management', icon: '💝',
    items: [
      { term: 'Pain', def: 'See WHO Analgesic Ladder. Key: "Total Pain" concept — physical + psychological + social + spiritual.', detail: 'Opioid-naïve: start morphine 5-10 mg PO Q4h + PRN. Titrate 25-50% daily until controlled. Always prescribe laxative with opioids.', pearl: 'Opioid-induced constipation: senna + docusate (start with opioid). If refractory: methylnaltrexone (peripheral mu-antagonist, doesn\'t cross BBB). Never "wait and see" — prescribe prophylactically.' },
  ...
  { id: 'hospice', title: 'Hospice & End-of-Life', icon: '🕊️',
    items: [
