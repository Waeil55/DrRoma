...
const ETHICS_SECTIONS = [
  { id: 'principles', title: 'Core Ethical Principles', icon: '⚖️',
    items: [
  ...
  { id: 'eol', title: 'End-of-Life Ethics', icon: '🕊️',
    items: [
  ...
  return (
    <div className="flex-1 min-h-0 flex flex-col">
      <div className="px-4 py-3 shrink-0" style={{ borderBottom: '1px solid var(--border)' }}>
        <h2 className="font-black text-xl flex items-center gap-2">⚖️ Medical Ethics</h2>
