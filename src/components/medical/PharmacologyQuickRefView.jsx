...
const PHARMA_CLASSES = [
  { cls: 'Beta Blockers', cat: 'Cardiology', moa: 'Block  (and ) adrenergic receptors  decrease HR, contractility, renin release',
    drugs: ['Metoprolol (-selective)', 'Atenolol (-selective)', 'Propranolol (non-selective)', 'Carvedilol (+)','Bisoprolol (-selective)','Nebivolol ( + NO release)'],
    ...
    pearls: ['Never stop abruptly  rebound tachycardia/HTN. Carvedilol & metoprolol succinate reduce HF mortality. -selective safer in mild COPD.'] },
  ...
  { cls: 'Corticosteroids', cat: 'Immunology', moa: 'Bind intracellular glucocorticoid receptors   NF-B   inflammatory cytokines,  prostaglandins. Broad immunosuppression.',
