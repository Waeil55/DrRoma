    ...
    sections: [
      ...
      { heading: 'ARDS Protocol (ARDSNet)',
        content: [
          ...
          'Driving pressure = Plateau  PEEP, keep <15 cmHO',
        ]},
  ...
  { id: 'shock', title: 'Shock Management', cat: 'Hemodynamics', icon: '',
    sections: [
      ...
      { heading: 'Vasopressors & Inotropes',
        content: [
          'Norepinephrine (Levophed): 1st line for septic shock.  >> . Start 0.1 mcg/kg/min, titrate to MAP 65.',
          'Vasopressin: 2nd line, add at 0.04 units/min (fixed dose). Reduces NE requirement. Use early.',
          'Epinephrine: Anaphylaxis (0.3-0.5 mg IM), cardiac arrest, refractory shock.  +  + .',
          'Dobutamine: Inotrope for cardiogenic shock ( contractility).  agonist. 2-20 mcg/kg/min.',
          'Phenylephrine: Pure  (vasoconstriction only). For neurogenic shock or reflex tachycardia.',
          'Milrinone: PDE-3 inhibitor. Inodilator ( contractility + vasodilation). Right heart failure.',
          'Dopamine: Dose-dependent: <5 (renal), 5-10 ( inotropic), >10 ( pressor). More arrhythmias than NE.',
        ]},
    ...
    sections: [
      ...
      { heading: 'Sedatives',
        content: [
          ...
          'Dexmedetomidine (Precedex): 0.2-1.5 mcg/kg/hr.  agonist. Cooperative sedation (arousable).  delirium. No resp depression.',
