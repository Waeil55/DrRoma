...
const ACHIEVEMENT_DEFS = [
  ...
  { id: 'ten_docs',       icon: '🏛️', label: 'Digital Library',    desc: 'Upload 10 documents',                   color: '#0891b2', check: (d) => d.length >= 10 },
  ...
  { id: 'note_taker',     icon: '✍️', label: 'Note Taker',         desc: 'Create 5 notes',                        color: '#f59e0b', check: (d, fc, ex, cs, nt) => nt.length >= 5 },
  // — Special —
